...
document.addEventListener("DOMContentLoaded", function() {
  document.getElementById("thq-button-filled cta1-button").addEventListener("click", function() {
    window.location.href = "http://localhost/Transportation%20MS//login-signup.php";
  });
});

document.addEventListener("DOMContentLoaded", function() {
  document.getElementById("hero3-button thq-button-filled").addEventListener("click", function() {
    window.location.href = "http://localhost/Transportation%20MS//login-signup.php";
  });
});
