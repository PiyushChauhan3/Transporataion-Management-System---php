            ...
            <div class="container mt-4">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<td>' . $row["pickup_add"] . '</td>';
                        echo '<td>' . $row["receiver_add"] . '</td>';
                        echo '<td>' . $row["goods_description"] . '</td>';
                        echo '<td>' . $row["status"] . '</td>';
                        echo '<td>' . $row["transport_date"] . '</td>';
                        echo '<td><a href="delete-booking.php?id=' . $row["id"] . '" class="btn btn-danger btn-sm">Delete</a></td>';
                        echo '</tr>';
                    }
                    ...
                    echo '<p class="alert alert-warning">No bookings found.</p>';
                }
