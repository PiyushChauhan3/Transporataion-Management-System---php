...
$sql = "SELECT bookings.booking_id, bookings.bus_id, bookings.seats_selected, 
               buses.bus_name, buses.departure_city, buses.arrival_city, 
               buses.departing_date, buses.returning_date, buses.bus_type 
        FROM bookings 
...
<head>
    ...
    <title>Booking List | Bootstrap Simple Admin Template</title>
