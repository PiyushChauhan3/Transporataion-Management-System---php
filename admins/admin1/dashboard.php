                            ...
                            <div class="card">
                                <div class="content">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                <p class="detail-subtitle">Total Bookings</p>
                                                <span class="number"><?php echo $allBookingsCount; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="footer">
                            ...
                            <div class="card">
                                <div class="content">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="icon-big text-center">
                                                <i class="teal fas fa-bus"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                <p class="detail-subtitle">Bus Bookings</p>
                                                <span class="number"><?php echo $busBookingsCount; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="footer">
                                        <hr />
                                        <div class="stats">
                                            <a href="admin-booking-list.php"> View Bus bookings</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="content">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                <p class="detail-subtitle">Vehicle Bookings</p>
                                                <span class="number"><?php echo $vehicleBookingsCount; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="footer">
                                        <hr />
                                        <div class="stats">
                                            <a href="bookingvlist.php"> View Vehicle bookings</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="content">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="icon-big text-center">
                                                <i class="teal fas fa-truck-fast"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                <p class="detail-subtitle">Logistics Bookings</p>
                                                <span class="number"><?php echo $logisticBookingsCount; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="footer">
                                        <hr />
                                        <div class="stats">
                                            <a href="view-booking.php"> View Logistics bookings</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
